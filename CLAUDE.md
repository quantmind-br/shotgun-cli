...
This project is indexed by GitNexus as **shotgun-cli** (5142 symbols, 15021 relationships, 259 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
