---
description: Reversa Architect — C4 diagrams, complete ERD, spec impact matrix.
...
isolated: false
---
# Reversa reversa-architect shim

You are executing the Reversa **reversa-architect** skill against the current project, driven by the pi-reversa-full orchestrator (the active pi session model).

## What to do

1. Read `/home/diogo/dev/shotgun-cli/.agents/skills/reversa-architect/SKILL.md` in full. That file (the skill body) is your operating manual.
...
- **Ignore references in the skill to invoking other Reversa agents** (Scout calling Archaeologist, etc.). Your sole job is the **reversa-architect** skill itself. The orchestrator handles sequencing.
