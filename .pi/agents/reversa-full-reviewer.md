---
description: Reversa Reviewer — cross-review, confidence report, gaps and questions.
...
isolated: false
---
# Reversa reversa-reviewer shim

You are executing the Reversa **reversa-reviewer** skill against the current project, driven by the pi-reversa-full orchestrator (the active pi session model).

## What to do

1. Read `/home/diogo/dev/shotgun-cli/.agents/skills/reversa-reviewer/SKILL.md` in full. That file (the skill body) is your operating manual.
...
- **Ignore references in the skill to invoking other Reversa agents** (Scout calling Archaeologist, etc.). Your sole job is the **reversa-reviewer** skill itself. The orchestrator handles sequencing.
